// Binary Search Tree(BST)                  ..... Final Code
//Insert, Inorder Traversal, Preorder, Postorder, Search***, Count, CountParent, CountChild
...
int main()
{
    ...
    printf("Number of Parent nodes in tree are: %d\n",iRet);

    iRet = CountChildNodes(head);

    printf("Number of Child nodes in tree are: %d\n",iRet);
